...
export const MODULE_LIBRARY: ModuleSpec[] = [
  ...
  // ─── Swing Structure ───────────────────────────────────────────────────────
  {
    ...
    concept:
      "Detects confirmed pivot highs and lows (fractal strength N left / M right). " +
    ...
    roles: [
      {
        role: "direction",
        fit: "primary",
        usage: "HH/HL bull or LH/LL bear bias from confirmed pivots (IsBull/IsBear).",
      },
      {
        role: "setup",
        fit: "secondary",
    ...
    params: [
      ...
      },
      {
        ...
        default: 3,
        range: [1, 10],
        description: "Bars on the older side of a pivot",
        traderPhrases: ["3-bar pivots", "5 left bars"],
      },
      {
        name: "swingRight",
        type: "int",
        default: 3,
        range: [1, 10],
        description: "Bars on the newer side of a pivot",
        traderPhrases: ["3-bar confirmation"],
      },
    ],
    outputStates: [
      {
        name: "IsBull() / IsBear()",
        meaning: "HH+HL or LH+LL bias from last two pivots each side",
        tradingImplication: "Direction brain bias",
      },
      {
        name: "BullJustConfirmed() / BearJustConfirmed()",
        meaning: "Swing high/low confirmed this bar",
        tradingImplication: "New pivot level available",
      },
      {
        name: "ActiveBullSL() / ActiveBearSL()",
        meaning: "Last swing low / high",
        tradingImplication: "SL reference for setup",
      },
    ],
    inlineApi: {
      tick: "SWINGSM_{id}_Tick(lookback)",
      signals: [
      ...
      reset: "SWINGSM_{id}_Reset()",
    },
    examplePhrases: [
      "Use swing structure on D1 for direction",
  ...
  // ─── Breaker Block (SMC - failed OB flip) ───────────────────────────────────
  {
    ...
    label: "Breaker Block",
    aliases: [
      { phrase: "breaker block" },
      { phrase: "smc breaker block" },
      { phrase: "smc bb" },
      { phrase: "failed order block" },
      { phrase: "ob flip" },
      { phrase: "broken order block" },
    ],
    concept:
    ...
    roles: [
      {
        role: "setup",
        fit: "primary",
        usage: "Active BB in bias direction = flip zone to watch for retest.",
      },
      {
        role: "execution",
        fit: "primary",
    ...
    params: [
      {
        ...
        default: 500,
        range: [100, 800],
        description: "Bars scanned for displacement and BB lifecycle",
        traderPhrases: [],
      },
      {
        name: "dispMult",
      ...
      },
      {
        ...
        traderPhrases: ["scan 5 bars for OB"],
      },
      {
        name: "expiryBars",
        type: "int",
        default: 100,
        range: [10, 500],
        description: "Bars before BB expires",
        traderPhrases: [],
      },
    ],
    outputStates: [
      {
        name: "HasActiveBull()",
        meaning: "Bullish breaker block zone is live",
        tradingImplication: "Buy zone from failed bearish OB",
      },
      {
        name: "HasActiveBear()",
        meaning: "Bearish breaker block zone is live",
        tradingImplication: "Sell zone from failed bullish OB",
      },
      {
        name: "BullJustConfirmed()",
        meaning: "Bull BB retested and confirmed this bar",
        tradingImplication: "ENTRY LONG",
      },
      {
        name: "BearJustConfirmed()",
        meaning: "Bear BB retested and confirmed this bar",
        tradingImplication: "ENTRY SHORT",
      },
    ],
    inlineApi: {
      tick: "BBSM_{id}_Tick(lookback)",
      signals: [
        { fn: "BBSM_{id}_HasActiveBull()", returns: "bool", meaning: "Live bull BB" },
        { fn: "BBSM_{id}_HasActiveBear()", returns: "bool", meaning: "Live bear BB" },
        { fn: "BBSM_{id}_BullJustConfirmed()", returns: "bool", meaning: "Bull BB confirmed" },
    ...
    examplePhrases: [
      "Enter on breaker block retest after failed order block",
      "Trade the SMC breaker zone on H4",
  ...
  // ─── RSS / SRR (Repeated Support / Resistance Sweep) ─────────────────────────
  {
    id: "rss_srr",
    label: "RSS / SRR",
    aliases: [
      ...
      { phrase: "rss srr" },
      { phrase: "rss/srr" },
      { phrase: "repeated support sweep" },
      { phrase: "repeated resistance sweep" },
      { phrase: "resistance sweeps supports" },
    ...
    detectionLogic:
      ...
      "Invalidation: close beyond driving level wick extreme (above R high / below S low).",
    roles: [
      {
        role: "setup",
        fit: "secondary",
    ...
    params: [
      {
        ...
        default: 500,
        range: [100, 800],
        description: "Bars scanned for Classic SNR levels",
        traderPhrases: [],
      },
      {
        name: "minBreaks",
        ...
        default: 2,
        range: [2, 6],
        description: "Minimum opposite-side close-breaks before signal",
        traderPhrases: ["2 support breaks", "3 resistance breaks"],
      },
      {
        name: "expiryBars",
        type: "int",
        default: 150,
        range: [20, 600],
        description: "Bars until untouched level expires",
        traderPhrases: [],
      },
    ],
    outputStates: [
      {
        name: "BullJustConfirmed()",
        meaning: "SRR fired this bar",
        tradingImplication: "ENTRY LONG at driving Support",
      },
      {
        name: "BearJustConfirmed()",
        meaning: "RSS fired this bar",
        tradingImplication: "ENTRY SHORT at driving Resistance",
      },
      {
        name: "HasActiveBull() / HasActiveBear()",
        meaning: "Live SRR/RSS not yet invalidated",
        tradingImplication: "Setup reference level still valid",
      },
    ],
    inlineApi: {
    ...
    notSuitedFor: ["Non-Classic SNR strategies without candle-pair levels"],
    combinesWith: ["snr", "gap_snr", "rejection", "miss", "bos"],
  },

  // ─── RBR / DBD (Supply & Demand base zones) ──────────────────────────────────
  {
    id: "rbr_dbd",
    label: "RBR / DBD",
    aliases: [
      ...
      { phrase: "rbr dbd" },
      { phrase: "rbr/dbd" },
      { phrase: "rally base rally" },
      { phrase: "drop base drop" },
      { phrase: "supply demand zone" },
      { phrase: "demand zone" },
      { phrase: "supply zone" },
    ],
    concept:
      "Institutional base zones from leg-base-leg patterns. RBR (Rally-Base-Rally) marks a DEMAND zone; " +
      "DBD (Drop-Base-Drop) marks a SUPPLY zone. The base candle range is the reaction area.",
    detectionLogic:
      "Strong impulse leg → 1–6 small base candles → strong same-direction leg breaking out of the base. " +
      "Zone = base high..low. Invalidates when price closes through the zone (demand below base, supply above base).",
    roles: [
      {
        role: "setup",
        fit: "primary",
      ...
      },
      {
        role: "execution",
        fit: "primary",
        usage: "Fire on zone confirmation bar when trader wants immediate entry at leg-out close.",
      },
    ],
    lifecycle: "Leg-base-leg forms → zone live until retest/traded-through or expiry",
    params: [
      {
        name: "lookback",
        type: "int",
        default: 400,
        range: [100, 800],
        description: "Bars scanned for RBR/DBD patterns",
        traderPhrases: [],
      },
      {
        name: "expiryBars",
        ...
        default: 200,
        range: [20, 600],
        description: "Bars until untested zone expires",
        traderPhrases: [],
      },
      {
        name: "impulseRatio",
    ...
    outputStates: [
      ...
      },
      {
        ...
        meaning: "Zone low (demand) / zone high (supply)",
        tradingImplication: "SL beyond the base extreme",
      },
    ],
    inlineApi: {
    ...
    examplePhrases: [
      "Enter on RBR demand zone retest on H1",
      "DBD supply setup on H4 with engulfing entry",
      "Trade the rally-base-rally base as demand",
      "Drop-base-drop supply zone for shorts",
    ],
    notSuitedFor: ["Strategies without clear leg-base-leg structure"],
    combinesWith: ["order_block", "snr", "engulfing", "rejection", "mef", "bos"],
  },

  // ─── MEF (Manipulation Entry Formula) ────────────────────────────────────────
  {
    id: "mef",
    label: "MEF",
    aliases: [
      { phrase: "mef" },
      { phrase: "manipulation entry formula" },
      { phrase: "mef candle" },
      { phrase: "multi timeframe engulfing" },
      { phrase: "engulfing gap snr rbr" },
    ],
    concept:
      "Multi-timeframe engulfing confluence. A strong 2-candle engulfing on the main TF must contain " +
      "a Gap SNR (1 TF lower) and an RBR/DBD base (2 TF lower) inside the engulfing candle window.",
    detectionLogic:
      "Bullish MEF = bear→bull engulfing + Gap Support + RBR inside the engulf zone. " +
      "Bearish MEF = bull→bear engulfing + Gap Resistance + DBD inside the engulf zone. " +
      "SL hint = engulfing low (bull) / high (bear). Marks expire after expiryBars on main TF.",
    roles: [
      {
        role: "setup",
        fit: "primary",
      ...
      },
      {
        role: "execution",
        fit: "primary",
        usage: "Fire on MEF confirmation bar when trader wants immediate entry at engulf close.",
      },
    ],
    lifecycle: "Engulf + Gap SNR + RBR/DBD align → MEF live until expiry on main TF",
    params: [
      {
        name: "lookback",
        type: "int",
        ...
        traderPhrases: ["300 bar lookback on H4"],
      },
      {
        name: "expiryBars",
        type: "int",
        default: 150,
        range: [20, 600],
        description: "Main-TF bars until unfilled MEF mark expires",
        traderPhrases: [],
      },
      {
        name: "impulseRatio",
    ...
    outputStates: [
      ...
      {
        name: "BullConfirmSL() / BearConfirmSL()",
        meaning: "Engulfing low / high",
        tradingImplication: "Place SL beyond engulfing extreme",
      },
    ],
    inlineApi: {
      tick: "MEFSM_{id}_Tick(lookback)",
      signals: [
    ...
    examplePhrases: [
      "Enter on MEF candle confluence on H4",
      "H4 engulfing with H1 gap SNR and M30 RBR",
      "Manipulation entry formula setup on daily",
      "MEF setup, engulfing entry on M30",
    ],
    notSuitedFor: ["Single-timeframe-only strategies without gap SNR or RBR/DBD context"],
    combinesWith: ["gap_snr", "engulfing", "bos", "choch", "rbr_dbd"],
  },

  // ─── QM MEF (Quasimodo Manipulation Entry Formula) ───────────────────────────
  {
    id: "qm_mef",
    label: "QM MEF",
    aliases: [
      { phrase: "qm mef" },
      { phrase: "qm_mef" },
      { phrase: "quasimodo mef" },
      { phrase: "quasimodo manipulation entry" },
      { phrase: "engulfing born quasimodo" },
    ],
    concept:
      "A Quasimodo structure born from a higher-timeframe strong engulfing candle. " +
      "The LTF close-based QM forms inside the engulf window; entry is at the left shoulder retest.",
    detectionLogic:
      "HTF 2-candle engulfing required. LTF Quasimodo (close-based) inside the engulf window: " +
      "LS → pullback → head → confirmation → return to LS (right shoulder entry). " +
      "Optional Gap SNR / RBR / DBD near the left shoulder marks strength. Invalidates on head break.",
    roles: [
      {
        role: "setup",
        fit: "primary",
    ...
    params: [
      {
        ...
        default: 300,
        range: [100, 800],
        description: "HTF bars scanned for engulfing-born QM",
        traderPhrases: [],
      },
      {
        name: "expiryBars",
        ...
        default: 150,
        range: [20, 600],
        description: "HTF bars until unfilled QM_MEF expires",
        traderPhrases: [],
      },
      {
        name: "confTolFrac",
        ...
        default: 0.3,
        range: [0.1, 0.8],
        description: "Confluence proximity tolerance near left shoulder",
        traderPhrases: [],
      },
      {
        name: "impulseRatio",
    ...
    outputStates: [
      ...
      {
        name: "BullConfirmSL() / BearConfirmSL()",
        meaning: "Head level (SL reference)",
        tradingImplication: "Place SL beyond the QM head extreme",
      },
    ],
    inlineApi: {
    ...
    combinesWith: ["mef", "engulfing", "gap_snr", "bos", "rejection"],
  },
  ...
  // ─── Unicorn (BB + FVG overlap) ───────────────────────────────────────────
  {
    ...
    aliases: [
      ...
      { phrase: "bb fvg" },
      { phrase: "breaker fvg" },
      { phrase: "breaker block fvg" },
      { phrase: "breaker block with fvg" },
    ...
    roles: [
      ...
      },
      {
        role: "execution",
        fit: "primary",
        usage: "BullJustConfirmed/BearJustConfirmed when price taps the overlap pocket.",
      },
    ],
    lifecycle:
      "OB → Breaker flip → FVG overlap match → ACTIVE → overlap tapped (entry) | INVALIDATED (close through breaker) | EXPIRED",
    params: [
      {
        name: "lookback",
        type: "int",
      ...
      },
      {
        ...
        default: 15,
        range: [5, 50],
        description: "Max bars between breaker birth and matching FVG",
        traderPhrases: [],
      },
      {
        name: "uniExpiry",
    ...
    outputStates: [
      ...
      {
        name: "BullJustConfirmed() / BearJustConfirmed()",
        meaning: "Price tapped the overlap pocket this bar",
        tradingImplication: "ENTRY at the overlap pocket",
      },
      {
        name: "BullConfirmSL() / BearConfirmSL()",
        meaning: "Breaker zone low (bull) / high (bear)",
        tradingImplication: "SL beyond the breaker invalidation",
      },
    ],
    inlineApi: {
  ...
  // ─── Traders Dynamic Index ───────────────────────────────────────────────────
  {
    ...
    aliases: [
      { phrase: "tdi" },
      { phrase: "traders dynamic index" },
      { phrase: "trader dynamic index" },
      { phrase: "green crosses red" },
      { phrase: "green crosses above red" },
      { phrase: "green crosses below red" },
      { phrase: "tdi above yellow" },
      { phrase: "tdi below yellow" },
      { phrase: "market base line" },
      { phrase: "tdi bands expanding" },
      { phrase: "tdi bands contracting" },
    ],
    concept:
    ...
    roles: [
      {
        role: "direction",
        fit: "primary",
        usage: "IsBull/IsBear when Price Line is above/below Market Base Line.",
      },
      {
        role: "setup",
        fit: "primary",
        usage: "HasActiveBull/Bear on trend (or strong) state; arm while Price > MBL.",
      },
      {
        role: "execution",
        fit: "primary",
        usage: "BullJustConfirmed when green crosses red above yellow (and bear inverse).",
      },
    ],
    lifecycle: "Persistent trend states; one-bar cross/confirm/band-touch events on closed candles only",
    params: [
      {
        name: "rsiPeriod",
        type: "int",
        ...
        range: [2, 100],
        description: "RSI period",
        traderPhrases: ["RSI 13", "13-period RSI"],
      },
      {
        name: "rsiPricePeriod",
        type: "int",
        default: 2,
        range: [1, 50],
        description: "RSI Price Line smoothing",
        traderPhrases: [],
      },
      {
        name: "tradeSignalPeriod",
        type: "int",
        default: 7,
        range: [1, 50],
        description: "Trade Signal Line period",
        traderPhrases: [],
      },
      {
        ...
        default: 34,
        range: [5, 200],
        description: "Market Base Line period",
        traderPhrases: ["34 MBL"],
      },
      {
        name: "volatilityBandPeriod",
        type: "int",
        default: 34,
        range: [5, 200],
        description: "Volatility band period on RSI",
        traderPhrases: [],
      },
      {
        name: "volatilityBandDeviation",
        type: "double",
        default: 1.6185,
        range: [0.5, 4],
        description: "Band deviation multiplier",
        traderPhrases: [],
      },
    ],
    outputStates: [
      {
        name: "BullCross() / BearCross()",
        meaning: "Raw Price vs Signal cross on closed bar",
        tradingImplication: "Raw cross event",
      },
      {
        name: "BullJustConfirmed() / BearJustConfirmed()",
        meaning: "Cross while both lines are above/below MBL",
        tradingImplication: "ENTRY LONG / SHORT",
      },
      {
        name: "IsBull() / IsBear()",
        meaning: "Price Line above/below Market Base",
        tradingImplication: "Direction bias",
      },
      {
        name: "BandsExpanding() / BandsContracting()",
        meaning: "Band width vs prior closed bar",
        tradingImplication: "Volatility filter",
      },
    ],
    inlineApi: {
      tick: "TDISM_{id}_Tick(1)",
      signals: [
        {
          fn: "TDISM_{id}_BullJustConfirmed()",
          returns: "bool",
          meaning: "Bull confirmation cross this bar",
        },
        {
          fn: "TDISM_{id}_BearJustConfirmed()",
          returns: "bool",
          meaning: "Bear confirmation cross this bar",
        },
        { fn: "TDISM_{id}_BullCross()", returns: "bool", meaning: "Raw bullish Price/Signal cross" },
        { fn: "TDISM_{id}_BearCross()", returns: "bool", meaning: "Raw bearish Price/Signal cross" },
        { fn: "TDISM_{id}_IsBull()", returns: "bool", meaning: "Price Line > Market Base" },
        { fn: "TDISM_{id}_IsBear()", returns: "bool", meaning: "Price Line < Market Base" },
        { fn: "TDISM_{id}_PriceLine()", returns: "double", meaning: "RSI Price Line value" },
        { fn: "TDISM_{id}_SignalLine()", returns: "double", meaning: "Trade Signal Line value" },
        { fn: "TDISM_{id}_MarketBaseLine()", returns: "double", meaning: "Market Base Line value" },
        { fn: "TDISM_{id}_UpperBand()", returns: "double", meaning: "Upper volatility band" },
        { fn: "TDISM_{id}_LowerBand()", returns: "double", meaning: "Lower volatility band" },
        { fn: "TDISM_{id}_BandWidth()", returns: "double", meaning: "Upper - Lower" },
      ],
      reset: "TDISM_{id}_Reset()",
    },
    examplePhrases: [
      "Buy when green crosses red above yellow",
      "Sell when green crosses red below yellow",
      "TDI above the yellow line for bullish bias",
      "TDI below the yellow line for bearish bias",
      "Only trade when TDI bands are expanding",
      "Green crosses above red",
      "Green crosses below red",
    ],
    notSuitedFor: ["Ordinary RSI level filters - use rsi filter / RSI HD for divergence"],
    combinesWith: ["ema", "bb", "engulfing", "pin_bar", "fvg", "bos"],
  },
  ...
  breaker_block: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Historical bars scanned for OB displacement and BB lifecycle",
    },
    {
      key: "dispMult",
      ...
      max: 3.0,
      step: 0.1,
      hint: "Minimum displacement body as ATR multiple (same as BB_State_Module)",
    },
    {
      key: "scanBack",
      label: "OB Scan Lookback (bars)",
      ...
      max: 15,
      step: 1,
      hint: "Bars before displacement to find the opposing OB candle",
    },
    {
      key: "expiryBars",
      label: "Zone Expiry (bars)",
      ...
      max: 500,
      step: 10,
      hint: "Bars before an unfilled breaker block expires",
    },
  ],
  rss_srr: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Historical bars scanned for Classic SNR levels",
    },
    {
      key: "minBreaks",
      label: "Min Breaks",
      ...
      max: 6,
      step: 1,
      hint: "Opposite-side close-breaks required before RSS/SRR fires",
    },
    {
      key: "expiryBars",
      label: "Level Expiry (bars)",
      type: "number",
      default: 150,
      min: 20,
      max: 600,
      step: 10,
      hint: "Bars until an untouched SNR level expires",
    },
  ],
  mef: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Main-TF bars scanned for engulfing confluence",
    },
    {
      key: "expiryBars",
      label: "MEF Expiry (bars)",
      type: "number",
      default: 150,
      min: 20,
      max: 600,
      step: 10,
      hint: "Main-TF bars until an unfilled MEF mark expires",
    },
    {
      key: "impulseRatio",
      label: "Impulse Ratio",
      ...
      max: 0.9,
      step: 0.05,
      hint: "RBR/DBD leg candle body/range minimum",
    },
    {
      key: "baseMaxRatio",
      label: "Base Max Ratio",
      type: "number",
      default: 0.5,
      min: 0.1,
      max: 0.8,
      step: 0.05,
      hint: "RBR/DBD base candle body/range maximum",
    },
    {
      key: "maxBaseCandles",
      ...
      max: 10,
      step: 1,
      hint: "Maximum candles in an RBR/DBD base",
    },
    {
      key: "legBaseMult",
      label: "Leg/Base Multiplier",
      type: "number",
      default: 1.3,
      min: 1.0,
      max: 3.0,
  ...
  qm_mef: [
    {
      ...
      max: 800,
      step: 10,
      hint: "HTF bars scanned for engulfing-born QM patterns",
    },
    {
      key: "expiryBars",
      label: "QM Expiry (bars)",
      type: "number",
      default: 150,
      min: 20,
      max: 600,
      step: 10,
      hint: "HTF bars until an unfilled QM_MEF expires",
    },
    {
      key: "confTolFrac",
      label: "Confluence Tolerance",
      type: "number",
      default: 0.3,
      min: 0.1,
      max: 0.8,
      step: 0.05,
      hint: "Left-shoulder proximity tolerance for Gap SNR / RBR / DBD",
    },
    {
      key: "impulseRatio",
      label: "Impulse Ratio",
  ...
  rbr_dbd: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Bars scanned for RBR/DBD base patterns",
    },
    {
      key: "expiryBars",
      label: "Zone Expiry (bars)",
      ...
      max: 600,
      step: 10,
      hint: "Bars until an untested zone expires",
    },
    {
      key: "impulseRatio",
      label: "Impulse Ratio",
      ...
      max: 0.9,
      step: 0.05,
      hint: "Leg candle body/range minimum",
    },
    {
      key: "baseMaxRatio",
      label: "Base Max Ratio",
      ...
      max: 0.8,
      step: 0.05,
      hint: "Base candle body/range maximum",
    },
    {
      key: "maxBaseCandles",
      label: "Max Base Candles",
      ...
      max: 10,
      step: 1,
      hint: "Maximum candles in a base",
    },
    {
      key: "legBaseMult",
      label: "Leg/Base Multiplier",
  ...
  swing_structure: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Bars scanned for confirmed swing pivots",
    },
    {
      key: "swingLeft",
      ...
      max: 10,
      step: 1,
      hint: "Bars on the older side needed to confirm a pivot",
    },
    {
      key: "swingRight",
      ...
      max: 10,
      step: 1,
      hint: "Bars on the newer side needed to confirm a pivot",
    },
  ],
  breakout: [
    {
  ...
  unicorn: [
    {
      ...
      max: 800,
      step: 10,
      hint: "Bars scanned for OB/FVG/breaker patterns",
    },
    {
      key: "dispMult",
    ...
    {
      key: "pairWindow",
      label: "Pair Window (bars)",
      type: "number",
      default: 15,
      min: 5,
      max: 50,
      step: 1,
      hint: "Max bars between breaker birth and matching FVG",
    },
    {
      key: "uniExpiry",
      label: "Unicorn Expiry (bars)",
      type: "number",
      default: 250,
      min: 20,
      max: 600,
      step: 10,
      hint: "Bars before matched Unicorn expires",
    },
  ],
  rsi_hd: [
    {
  ...
  tdi: [
    {
      ...
      max: 100,
      step: 1,
      hint: "RSI period for the TDI composite",
    },
    {
      key: "rsiPricePeriod",
      label: "RSI Price Line Period",
      type: "number",
      default: 2,
      min: 1,
      max: 50,
      step: 1,
      hint: "Smoothing of raw RSI (green line)",
    },
    {
      key: "tradeSignalPeriod",
      label: "Trade Signal Period",
      type: "number",
      default: 7,
      min: 1,
      max: 50,
      step: 1,
      hint: "MA of Price Line (red line)",
    },
    {
      key: "marketBasePeriod",
      label: "Market Base Period",
      type: "number",
      default: 34,
      min: 5,
      max: 200,
      step: 1,
      hint: "MA of RSI (yellow line)",
    },
    {
      key: "volatilityBandPeriod",
      label: "Volatility Band Period",
      type: "number",
      default: 34,
      min: 5,
      max: 200,
      step: 1,
      hint: "MA/StdDev period on RSI for blue bands",
    },
    {
      key: "volatilityBandDeviation",
      label: "Volatility Band Deviation",
      type: "number",
      default: 1.6185,
      min: 0.5,
      max: 4,
      step: 0.0001,
      hint: "StdDev multiplier for upper/lower bands",
    },
    {
      key: "neutralTolerance",
      label: "Neutral Tolerance",
      type: "number",
      default: 0,
      min: 0,
      max: 5,
      step: 0.1,
      hint: "Price vs MBL deadband for neutral",
    },
    {
      key: "minBandWidth",
      ...
      max: 50,
      step: 0.1,
      hint: "Optional gate for expand/contract (0 = off)",
    },
  ],
};
