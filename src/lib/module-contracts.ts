...
export const MODULE_CONTRACTS: Record<string, ModuleContract> = {
  ...
  mef: {
    ...
    params: [
      ...
      },
      {
        ...
        type: "double",
        default: 1.3,
        description: "Leg range must exceed avg base range x this multiplier.",
      },
    ],
  ...
  tdi: {
    ...
    semanticEvents: [
      {
        ...
        queryFunctions: [
          ...
          "TDISM_{id}_IsBear()",
          "TDISM_{id}_Trend()",
          "TDISM_{id}_HasActiveBull()",
          "TDISM_{id}_HasActiveBear()",
          "TDISM_{id}_StrongBull()",
          "TDISM_{id}_StrongBear()",
        ],
        meaning: "RSI Price Line vs Market Base Line (yellow) trend state.",
      },
      {
        id: "tdi_cross",
        roles: ["setup", "execution"],
        queryFunctions: ["TDISM_{id}_BullCross()", "TDISM_{id}_BearCross()"],
        meaning: "Closed-bar RSI Price Line vs Trade Signal Line cross (green/red).",
      },
      {
        id: "tdi_confirmed",
        roles: ["setup", "execution"],
        queryFunctions: [
          "TDISM_{id}_BullJustConfirmed()",
          "TDISM_{id}_BearJustConfirmed()",
          "TDISM_{id}_BullConfirmed()",
          "TDISM_{id}_BearConfirmed()",
          "TDISM_{id}_BullConfirmSL()",
          "TDISM_{id}_BearConfirmSL()",
        ],
        meaning:
          "Price/Signal cross while both lines are above (bull) or below (bear) Market Base Line.",
      },
      {
        id: "tdi_band_touch",
        roles: ["setup", "execution"],
        queryFunctions: ["TDISM_{id}_UpperBandTouched()", "TDISM_{id}_LowerBandTouched()"],
        meaning: "RSI Price Line touches TDI volatility bands (not a trade by itself).",
      },
      {
        id: "tdi_band_state",
        roles: ["setup"],
        queryFunctions: ["TDISM_{id}_BandsExpanding()", "TDISM_{id}_BandsContracting()"],
        meaning: "TDI band width expanding or contracting vs prior closed bar.",
      },
    ],
    params: [
      { name: "rsiPeriod", type: "int", default: 13, description: "RSI period." },
      {
        name: "rsiAppliedPrice",
        type: "string",
        default: "PRICE_CLOSE",
        description: "RSI applied price.",
      },
      { name: "rsiPricePeriod", type: "int", default: 2, description: "RSI Price Line MA period." },
      {
        name: "rsiPriceMethod",
        type: "string",
        default: "sma",
        description: "RSI Price Line MA method.",
      },
      {
        name: "tradeSignalPeriod",
        type: "int",
        default: 7,
        description: "Trade Signal Line MA period.",
      },
      {
        name: "tradeSignalMethod",
        type: "string",
        default: "sma",
        description: "Trade Signal Line MA method.",
      },
      {
        name: "marketBasePeriod",
        type: "int",
        default: 34,
        description: "Market Base Line MA period.",
      },
      {
        name: "marketBaseMethod",
        type: "string",
        default: "sma",
        description: "Market Base Line MA method.",
      },
      {
        name: "volatilityBandPeriod",
        type: "int",
        default: 34,
        description: "Volatility band MA/StdDev period on RSI.",
      },
      {
        name: "volatilityBandDeviation",
        type: "double",
        default: 1.6185,
        description: "Volatility band deviation multiplier.",
      },
      {
        name: "neutralTolerance",
        type: "double",
        default: 0,
        description: "Neutral tolerance for Price vs Market Base.",
      },
      {
        name: "minBandWidth",
        type: "double",
        default: 0,
        description: "Optional minimum band width for expand/contract (0 = off).",
      },
    ],
    aliases: [
    ...
    notes:
      "Composite of RSI + MAs on RSI + bands on RSI. Prefix TDISM. Buffers 0-15 on TDI_State_Module.mq5. Closed-candle events only.",
  },
  engulfing: {
    id: "engulfing",
