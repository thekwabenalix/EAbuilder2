...
export const INDICATOR_REGISTRY: BuiltinIndicator[] = [
  ...
  },
  {
    ...
    mql5: "iADX",
    signature: "iADX(symbol, tf, adx_period)",
    category: "trend",
    via: "builtin",
    ...
    subWindow: true,
    aliases: ["adx", "average directional movement", "directional movement"],
    description: "Trend strength (ADX) plus directional indicators +DI/-DI.",
    applications: ["Trend filter", "Direction Brain"],
  },
  {
    id: "adxw",
    name: "Average Directional Movement Index Wilder",
    mql5: "iADXWilder",
    signature: "iADXWilder(symbol, tf, adx_period)",
    category: "trend",
    via: "builtin",
    params: [{ name: "adx_period", type: "int", default: 14, min: 1, max: 1000 }],
    buffers: [
    ...
    subWindow: true,
    aliases: ["adx wilder", "adxwilder", "wilder adx"],
    description: "Wilder-smoothed ADX / DI system.",
    applications: ["Trend filter"],
  },
  {
    id: "dema",
    ...
    mql5: "iDEMA",
    signature: "iDEMA(symbol, tf, ma_period, ma_shift, applied_price)",
    category: "trend",
    via: "builtin",
    params: [
      { name: "ma_period", type: "int", default: 14, min: 1, max: 1000 },
    ...
    buffers: [{ index: 0, name: "DEMA line" }],
    subWindow: false,
    aliases: ["dema", "double exponential", "double ema"],
    description: "Double-smoothed EMA - less lag than classic EMA.",
    applications: ["Trend filter", "Crossovers"],
  },
