...
const PHASE1_MODULES: ModuleEntry[] = [
  {
    ...
    name: "FVG Detector",
    description: "Detects 3-candle Fair Value Gaps on any timeframe.",
    rules: [
    ...
    output: [
      "Filled rectangle drawn for every detected zone",
      "Label: direction, id, UL and LL",
      'Journal: FVG_CREATED | id | dir | C1_time | C3_time | UL | LL',
    ],
    status: "ready",
